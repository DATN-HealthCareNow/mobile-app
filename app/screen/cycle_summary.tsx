...
export default function CycleSummaryScreen() {
    ...
    const speed = (params.speed as string) || "0.0";
    ...
    const handleShareRoute = async () => {
        ...
        try {
            ...
            if (isShareAvailable) {
                await Sharing.shareAsync(mapImageUri, { dialogTitle: "Check out my ride on HealthCareNow!" });
            } else {
    ...
    return (
        <ScrollView style={[styles.container, { backgroundColor: colors.background }]} contentContainerStyle={{ paddingBottom: 40 }}>
            ...
            {mapImageUri ? (
                ...
                <LinearGradient
                    colors={isDark ? ['#16a34a', '#14532d'] : ['#4ade80', '#16a34a']}
                    style={styles.heroBackground}
                >
                    <View style={styles.trophyContainer}>
                        <View style={styles.trophyGlow} />
                        <Ionicons name="bicycle" size={80} color="#fde047" />
                    </View>
                    <Text style={styles.title}>Ride Completed!</Text>
                    <Text style={styles.subtitle}>Keep pushing those pedals!</Text>
                </LinearGradient>
            )}
            ...
            <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
                ...
                <View style={styles.primaryStatBox}>
                    ...
                    <View style={styles.primaryRow}>
                        <Text style={[styles.primaryValue, { color: isDark ? colors.text : '#16a34a' }]}>{distance.toFixed(2)}</Text>
                ...
                <View style={styles.grid}>
                    ...
                    <View style={[styles.gridItem, styles.gridBorder, { borderColor: colors.border }]}>
                        ...
                        <Text style={[styles.gridValue, { color: colors.text }]}>{speed}</Text>
                    </View>
                    <View style={styles.gridItem}>
